...
Page({
  ...
  dayEditPlan: null as MealPlan | null,
  todayEditPlan: null as MealPlan | null,
  ...
  async saveDayEditSlots(slots: any[]) {
    ...
    const plan = { date: this.data.dayEditDate, meals }
    await saveMealPlans([plan], this.dayEditPlan ? [this.dayEditPlan] : undefined)
    if (this.dayEditPlan) this.dayEditPlan = { ...this.dayEditPlan, ...plan }
  },
  ...
  async saveTodayEdit() {
    ...
    const plan = { date: getToday(), meals }
    await saveMealPlans([plan], this.todayEditPlan ? [this.todayEditPlan] : undefined)
    if (this.todayEditPlan) this.todayEditPlan = { ...this.todayEditPlan, ...plan }
